...
export default function AdminLayout() {
  ...
  // Check if current route is clients page
  ...
  return (
    <div className="admin-layout min-h-screen bg-gradient-to-br from-white via-gray-100 to-white">
      ...
      {!isMobile ? (
        <div className="flex">
          {/* Sidebar Desktop - Hidden on Clients page */}
          {!isClientsPage && <ModernDesktopSidebar />}

          {/* Main Content */}
          <div className={`${isClientsPage ? 'w-full' : 'flex-1'} min-h-screen`}>
        ...
        <div className="flex flex-col min-h-screen">
          {/* Header Mobile - Hidden on Clients page */}
          {!isClientsPage && (
            <ModernMobileHeader
          ...
          {/* Sidebar Mobile - Hidden on Clients page */}
          {!isClientsPage && (
            <ModernMobileSidebar
          ...
          {/* Main Content Mobile */}
          <div className={`${isClientsPage ? 'flex-1' : 'flex-1 pt-16'}`}>
