...
const QuoteModal = ({ isOpen, onClose, defaultService }) => {
  ...
  const validate = () => {
    ...
    if (formData.website && !/^https?:\/\/.+\..+/.test(formData.website))
      newErrors.website = 'URL valide requise';
    return newErrors;
  };
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div>
                ...
                <div className="relative">
                  <span className="absolute left-2 top-2 text-blue-400">
                    👤
                  </span>
                  <input
                    ref={firstInputRef}
                    ...
                    className={`w-full border rounded pl-8 px-3 py-2 focus:outline-none focus:ring-2 ${
                      errors.name
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full border rounded pl-8 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"
                  />
                </div>
              </div>
              <div>
