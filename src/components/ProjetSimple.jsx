...
export default function ProjetSimple() {
  return (
    <section id="projects" className="py-12 px-4 bg-dark-200">
      <div className="container mx-auto max-w-6xl">
        ...
        <p className="text-lg md:text-xl text-center mb-12 text-gray-300 max-w-2xl mx-auto">
          Découvrez les solutions et services informatiques réalisés par notre
          agence : développement web, applications métiers, sécurité, cloud,
          maintenance et transformation digitale pour nos clients
          professionnels.
        </p>
