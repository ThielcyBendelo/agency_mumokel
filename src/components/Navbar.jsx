...
export default function Navbar() {
  ...
  const resourcesItems = [
    { href: '/gestion-utilisateurs', label: 'Gestion des utilisateurs', icon: '👥' },
    { href: '/gestion-paiement', label: 'Gestion de paiement', icon: '💳' },
  ];
        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex md:items-center md:space-x-8">
            ...
            <div className="relative">
              ...
              {/* Dropdown Menu */}
              {isResourcesOpen && (
                <div className="absolute top-full mt-2 w-64 bg-dark-200/95 backdrop-blur-xl border border-white/10 rounded-lg shadow-xl py-2 z-50">
                  {resourcesItems.map((item) => (
                    <Link
                      ...
                      onMouseEnter={() => audioService.playHover()}
                      className="flex items-center gap-3 px-4 py-3 text-gray-300 hover:text-white hover:bg-white/5 transition-all duration-200"
                    >
        ...
        <div className="md:hidden bg-dark-200/95 backdrop-blur-md border-t border-purple/20 absolute top-16 left-0 right-0 z-40">
          ...
          <div className="px-2 pt-4 pb-6 space-y-2">
            ...
            <div className="px-4 py-2">
              <div className="text-sm font-semibold text-gray-400 mb-2">Ressources</div>
              {resourcesItems.map((item) => (
                <Link
                  key={item.href}
                  to={item.href}
